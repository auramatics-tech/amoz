...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
            ...
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">All Orders</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
        <!--begin::Actions-->
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app"><span
            ...
            <a href="#" class="btn btn-sm btn-primary disabled" data-bs-toggle="modal" data-bs-target="#">Edit
                Order</a>
            <button id="kt_engage_demos_toggle" class="btn btn-sm btn-primary" title="Check out 22 more demos"
                data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">
                <span id="kt_engage_demos_label">Submit Claim</span>
            </button>
            <button class="btn" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app_search">
                                                            ...
                                                            <span class="svg-icon svg-icon-1 svg-icon-danger">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    ...
                                                                    <rect opacity="0.3" x="13"
                                                                        y="2" width="9" height="9"
                                                                        rx="2" fill="currentColor" />
                                                                    <rect opacity="0.3" x="13"
                                                                        y="13" width="9" height="9"
                                                                        rx="2" fill="currentColor" />
...
<!--begin::Modal - Create App-->
<div class="modal fade" id="kt_modal_create_app_search" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <!--begin::Modal content-->
        <div class="modal-content">
            ...
            <div class="modal-body py-lg-10 px-lg-10">
                <!--begin::Stepper-->
                <form class="form" novalidate="novalidate" id="kt_invoice_form">
                    <div class="row">
                        <!--begin::Aside-->
                        <div class="col-md-4">
