...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <!--begin::Container-->
        <div id="kt_content_container" class="px-10 w-100">
            <!--begin::Row-->
                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    ...
                                    <thead>
                                        <tr class="fw-bolder text-muted">
                                            <th class="min-w-150px text-dark fw-bolder text-hover-primary fs-6">Eform ID</th>
                                            <th class="min-w-150px text-dark fw-bolder text-hover-primary fs-6">Order No</th>
                                            <th class="min-w-150px text-dark fw-bolder text-hover-primary fs-6">Invoice</th>
                                            <th class="min-w-200px text-dark fw-bolder text-hover-primary fs-6">Name/company</th>
                                            <th class="min-w-150px text-dark fw-bolder text-hover-primary fs-6">Agent</th>
                                            <th class="min-w-150px text-dark fw-bolder text-hover-primary fs-6">Package</th>
                                            <th class="min-w-150px text-dark fw-bolder text-hover-primary fs-6">Status</th>
                                            <th class="min-w-100px text-end text-dark fw-bolder text-hover-primary fs-6 pe-5">Actions</th>
                                        </tr>
                                    </thead>
                                    <!--end::Table head-->
                                    <!--begin::Table body-->
                                    <tbody>
                                        <tr>
                                            <td>
                                                <span class="text-dark d-block fs-7">1234</span>     
                                            </td>
                                            <td>
                                                <span class="text-dark d-block fs-7">34</span>
                                            </td>
                                            <td>
                                                <span class="text-dark d-block fs-7">submitted</span>     
                                            </td>
                                            <td>
                                                <span class="text-dark d-block fs-7">company 1</span>
                                            </td>
                                            <td>
                                                <span class="text-dark d-block fs-7">Mr.John</span>     
                                            </td>
                                            <td>
                                                <span class="text-dark d-block fs-7">100 home</span>
                                            </td>
                                            <td>
...
@endsection
@section('scripts')
<script src="{{asset('js/custom/apps/invoices/date.js')}}"></script>
<script>
